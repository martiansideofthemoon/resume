...
\vspace*{0.1in}
\begin{itemize}[leftmargin=*]
\item University of Southern California, July 2021 (upcoming) \\
\textit{(On progress in text generation \& perils of its evaluation)}
\item University of Texas at Austin, June 2021 (upcoming)\\
\textit{(On progress in text generation \& perils of its evaluation)}
...
\vspace*{0.1in}
\begin{itemize}[leftmargin=*]
\item \textbf{Program Committee / Reviewer} for IJCV '19, EMNLP '19, '20, '21; ACL '20, '21; ICLR '21; NAACL '21; NeurIPS '21 and several other workshops
