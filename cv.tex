...
Also see my \href{https://scholar.google.com/citations?hl=en&user=9g2BsMUAAAAJ}{Google Scholar} profile. ACL, ICLR, EMNLP, NAACL are top-tier peer-reviewed conferences in ML/NLP with an acceptance rate of  20-30\%.
\vspace{0.1in}

{\normalsize \textbf{Selected Papers}:}

\begin{enumerate}[leftmargin=*]
\setlength\itemsep{0.4em}


\item \href{tbd}{LongEval: Guidelines for Human Evaluation of Faithfulness in Long-form Summarization} \\
...
\item User and Technical Perspectives of Controllable Code Generation \\
...
\vspace*{0.1in}
\begin{itemize}[leftmargin=*]
\item \textbf{Program Committee / Reviewer} for ACL Rolling Review, EMNLP '19-22; ACL '19-'23; ICLR '21-'23; NAACL '19-'22; NeurIPS '21-'22; EACL '23; IJCV '19 and several other workshops
